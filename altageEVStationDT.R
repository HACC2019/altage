...
Amount <- ifelse(edata$Session.Amount <= 4.804, "< $4.8", "> $4.8")

TimeOfDay <- ifelse(HourOfDay == "0", "Off-Peak",
                    ifelse(HourOfDay == "1", "Off-Peak",
                           ifelse(HourOfDay == "2", "Off-Peak",
                                  ifelse(HourOfDay == "3", "Off-Peak",
                                         ifelse(HourOfDay == "4", "Off-Peak",
                                                ifelse(HourOfDay == "5", "Off-Peak",
                                                       ifelse(HourOfDay == "6", "Off-Peak",
                                                              ifelse(HourOfDay == "7", "Off-Peak",
                                                                     ifelse(HourOfDay == "8","Mid-Day",
                                                                            ifelse(HourOfDay == "9", "Mid-Day",
                                                                                   ifelse(HourOfDay == "10", "Mid-Day",
                                                                                          ifelse(HourOfDay == "11","Mid-Day",
                                                                                                 ifelse(HourOfDay == "12", "Mid-Day",
                                                                                                        ifelse(HourOfDay == "13", "Mid-Day",
                                                                                                               ifelse(HourOfDay == "14","Mid-Day",
                                                                                                                      ifelse(HourOfDay == "15", "Mid-Day",
                                                                                                                             ifelse(HourOfDay == "16", "On-Peak",
                                                                                                                                    ifelse(HourOfDay == "17","On-Peak",
                                                                                                                                           ifelse(HourOfDay == "18", "On-Peak",
                                                                                                                                                  ifelse(HourOfDay == "19", "On-Peak",
                                                                                                                                                         ifelse(HourOfDay == "20", "On-Peak",
                                                                                                                                                                ifelse(HourOfDay == "21" ,"Of-Peak",
                                                                                                                                                                       ifelse(HourOfDay == "22", "Off-Peak","Off-Peak")))))))))))))))))))))))
...
tree.edata = tree(Energy~.-Energy.kWh., data=edata)
summary(tree.edata)
#Plot tree
plot(tree.edata)
text(tree.edata, use.n=TRUE, all=TRUE, cex=.7, pretty=0)

tree.edata #Detailed Summary of tree

#Implement Decision Tree with rpart package without Energy.kWh column
fit <- rpart(Energy~.-Energy.kWh., data=edata)
#Plot
